...
namespace Natrium
{
    internal sealed class AuthenticatedPublicKeyCrypto64 : IAuthenticatedPublicKeyCrypto
    {
        ...
        public PublicKeyCryptoKeyPair CreateRandomKeyPair()
        {
            ...
            var result = PlatformInvoke64.crypto_box_keypair(publicKey, secretKey);
        ...
        {
            private readonly AuthenticatedPublicKeyCrypto64 _parent;
            private readonly byte[] _sharedSecret;

            public AuthenticatedPublicKeyCryptoContext(AuthenticatedPublicKeyCrypto64 parent, byte[] sharedSecret)
            {
                _parent = parent;
